...
if remaining_time <= 0:
    if score_left > score_right:
        display_victory(gameDisplay, display_width, display_height, "Game Over", boyFirstLeftVictoryImg, "Player 1 ชนะ!")
    elif score_right > score_left:
        display_victory(gameDisplay, display_width, display_height, "Game Over", boySecondRightVictoryImg, "Player 2 ชนะ!")
    else:
        display_victory(gameDisplay, display_width, display_height, "Game Over", None, "เสมอกัน!")
    
    # แสดงปุ่ม 'รีเกม' และ 'ออกจากเกม' หลังประกาศผล
    reset_action = buttons.button(gameDisplay, "รีเกม", 350, 400, 100, 50, (0, 255, 0), (0, 200, 0), 'reset')
    exit_action = buttons.button(gameDisplay, "ออก", 750, 400, 100, 50, (255, 0, 0), (200, 0, 0), 'exit')
