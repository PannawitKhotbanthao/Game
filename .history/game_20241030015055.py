...
if remaining_time <= 0:
    if score_left > score_right:
        winner_text = "Player 1 ชนะ!"
        winner_img = boyFirstLeftVictoryImg
    elif score_right > score_left:
        winner_text = "Player 2 ชนะ!"
        winner_img = boySecondRightVictoryImg
    else:
        winner_text = "เสมอกัน!"
        winner_img = None

    # เรียกใช้ Paused.paused เพื่อแสดงผลลัพธ์พร้อมภาพท่าดีใจของผู้ชนะ
    Paused.paused(gameDisplay, display_width, display_height, "Game Over", pause=True, winner=winner_text, winner_img=winner_img)
