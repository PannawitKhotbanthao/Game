...
def paused(gameDisplay, display_width, display_height, message, pause=False, winner=None, winner_img=None):
    ...
    boyFirstLeftVictoryImg = pygame.image.load('images/ronaldo_action.png')boySecondRightVictoryImg = pygame.image.load('images/messi_action.png')
    ...
    while pause:
        ...
        if startAction == 'back_to_intro':
            # รีเซ็ตสถานะเกม
            pause = False  # ปิด pause mode
            return "restart"  # ส่งสัญญาณรีสตาร์ทไปยังโค้ดหลัก
