...
import Paused
import sys
sys.path.append("d:/Fucking Work/Python-2D-Football-Game/black.py")
...
backImg = background.load_background_frames(frame_folder, display_width, display_height)
...
while running:
    ...
    frame_index = background.display_background(screen, backImg, frame_index)
