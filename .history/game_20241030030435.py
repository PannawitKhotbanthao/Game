...
def display_buttons(gameDisplay, display_width, display_height):
    ...
    reset_game = buttons.button(gameDisplay, "รีเกม", display_width / 3, display_height / 2, 100, 50, (0, 255, 0), (0, 200, 0), 'reset', font=button_font)
    exit_game = buttons.button(gameDisplay, "ออก", display_width * 2 / 3, display_height / 2, 100, 50, (255, 0, 0), (200, 0, 0), 'exit', font=button_font)
