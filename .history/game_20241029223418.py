...
def game_background():
    backImg = get_next_frame()  # ดึงเฟรมถัดไปของวิดีโอ
    if backImg is not None:
        screen.blit(backImg, (0, 0))  # แสดงผลเฟรมบนหน้าจอ
...
while not crashed:
    ...
    game_background(0, display_height - goal_height, display_width - goal_width, display_height - goal_height)
