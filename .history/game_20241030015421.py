...
if remaining_time <= 0:  # เมื่อหมดเวลา
    if score_left > score_right:
        Paused.paused(gameDisplay, display_width, display_height, "Game Over", pause=True, winner="Player 1 ชนะ!")
    elif score_right > score_left:
        Paused.paused(gameDisplay, display_width, display_height, "Game Over", pause=True, winner="Player 2 ชนะ!")
    else:
        Paused.paused(gameDisplay, display_width, display_height, "Game Over", pause=True, winner="เสมอกัน!")
