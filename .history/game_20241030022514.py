...
def main_game(gameDisplay, display_width, display_height):
    # โค้ดสำหรับการทำงานของเกมหลัก เช่น ลูปหลักของเกม
    running = True
    while running:
        ...
        # โค้ดอื่น ๆ สำหรับการแสดงผลของเกม
        gameDisplay.fill((0, 0, 0))  # แสดงพื้นหลังสีดำหรืออื่น ๆ
        pygame.display.flip()
...
if remaining_time <= 0:
    ...
    if score_left > score_right:
        Paused.display_victory(gameDisplay, display_width, display_height, "Game Over", boyFirstLeftVictoryImg, "Player 1 ชนะ!")
    elif score_right > score_left:
        Paused.display_victory(gameDisplay, display_width, display_height, "Game Over", boySecondRightVictoryImg, "Player 2 ชนะ!")
    else:
        Paused.display_victory(gameDisplay, display_width, display_height, "Game Over", None, "เสมอกัน!")

    # แสดงปุ่ม 'รีเซ็ตเกม' และ 'ออกจากเกม'
